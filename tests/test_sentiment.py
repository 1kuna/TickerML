#!/usr/bin/env python3
"""
Test script for Qwen 3 sentiment analysis
"""
...
from pc.features import analyze_sentiment_with_qwen3

def test_sentiment_analysis():
    """Test the Qwen 3 sentiment analysis function"""
    ...
    print("Testing Qwen 3 Sentiment Analysis")
    print("=" * 50)
    ...
    for i, text in enumerate(test_cases, 1):
        ...
        try:
            sentiment_score = analyze_sentiment_with_qwen3(text)
